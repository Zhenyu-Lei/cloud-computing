...
struct Dance
{
    ...
    bool solve(int board[N],int spaces[N],int nspaces)
    {
        if (root_->left == root_) {
...
static void find_spaces(int board[N],int spaces[N],int nspaces)
{
  nspaces = 0;
